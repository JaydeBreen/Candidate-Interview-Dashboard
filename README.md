...
- Displays 4 stat cards (excludes a card for pending statuses):
  - Total Candidates (includes the pending statuses)
  - Hired
  - Rejected
  - Interviewing
...
- Search bar to search by name/surname

### 🔍 Candidate Details (Modal)
- Click "View/update" to open modal
- Shows complete information
- Can update status of candidate
